...
<div id="Container">
    ...
    <div id="small_container">
         ...
         <div id="form-container">
          ...
          <form action="{{url('/update_employe/'.$employe->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            <h1>Modifier Un Employee</h1>
            <input type="text" name="full_name" placeholder="nom complet" value="{{$employe->full_name}}"><br>
            <input type="text" name="email" placeholder="email" value="{{$employe->email}}"><br>
            <textarea name="description" placeholder="description"  cols="30" rows="10">{{$employe->description}}</textarea><br>
