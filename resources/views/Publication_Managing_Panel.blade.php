...
<div id="Container">
    ...
    <div id="small_container">
       ...
       <div id="form_container">
        ...
        @csrf
        <h1>Publier</h1>
        <div><input type="text" name="title" placeholder="Titre"></div>
          <div><input type="text" name="objectif"  placeholder="Objectif"></div>
          <div><textarea placeholder="Description"   name="description" cols="30" rows="20"></textarea></div>
