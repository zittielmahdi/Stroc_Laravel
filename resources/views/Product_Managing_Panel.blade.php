    ...
    <div id="small_container">
        ...
        <div id="form_container">
            <form action="{{route('add_product')}}" method="POST" enctype="multipart/form-data">
                ...
                <div><input type="text" name="product_name" placeholder="nom du produit"></div>
                <div><input type="text" name="brand" placeholder="marque"></div>
                <div><input type="text" name="serial_number" placeholder="numero de serie"></div>
                <div><input type="text" name="price_per_unit" placeholder="prix unitaire"></div>
                <div><input type="text" name="tva" placeholder="tva"></div>
                <div><input type="text" name="quantity" placeholder="quantite"></div>
